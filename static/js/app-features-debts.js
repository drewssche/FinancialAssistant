(() => {
  ...
  const api = {
    ...
    forgiveDebtFromRepaymentFlow: debtModalsFeature?.forgiveDebtFromRepaymentFlow,
    updateRepaymentDeltaHint: debtModalsFeature?.updateRepaymentDeltaHint,
    openDebtIssuanceModal: debtModalsFeature?.openDebtIssuanceModal,
    closeDebtIssuanceModal: debtModalsFeature?.closeDebtIssuanceModal,
    submitDebtIssuance: debtModalsFeature?.submitDebtIssuance,
    updateIssuanceDeltaHint: debtModalsFeature?.updateIssuanceDeltaHint,
    openDebtForgivenessModal: debtModalsFeature?.openDebtForgivenessModal,
    closeDebtForgivenessModal: debtModalsFeature?.closeDebtForgivenessModal,
    submitDebtForgiveness: debtModalsFeature?.submitDebtForgiveness,
