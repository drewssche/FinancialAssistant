"""backfill legacy manual fx settlements
...
def upgrade() -> None:
    ...
    for trade in trade_rows:
        ...
        bind.execute(
            ...
            .values(linked_operation_id=matched_operation_id, trade_kind="card_payment")
        )
