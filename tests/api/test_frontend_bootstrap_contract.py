...
def test_index_html_uses_manifest_bootstrap_pair():
    ...
    assert "/static/js/app-manifest.js?v=20260826e" in script_sources
    assert "/static/js/app-bootstrap.js?v=20260826e" in script_sources
...
def test_bootstrap_fetches_manifest_scripts_in_parallel_with_ordered_execution():
    ...
    assert 'const assetVersion = "20260826e"' in bootstrap
